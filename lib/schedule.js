...
export function simplifyStudentActivityName(value) {
  ...
  if (lower === "what is a leader?") return "The Power of Leadership";
  ...
  if (lower.includes("group challenge debrief")) return "Group Challenge Debrief";
  if (lower.startsWith("escape to disorientation")) return "Escape to Disorientation";
  if (lower === "disorientation") return "Disorientation";
  if (lower.includes("group challenge")) return "Group Challenge";
  if (lower.includes("team meeting 4")) return "Lunch / Team Mtg 4";
  ...
  if (lower.includes("candle ceremony")) return "Candle Ceremony";
  if (lower.includes("bonfire")) return "Evening Social";
  if (lower.startsWith("team final debrief")) return "TORCH Wrap Up";
  if (lower.startsWith("wake-up call")) return "Wake-Up Call";
  if (lower.startsWith("lunch")) return "Lunch w/ Team";
  if (lower.startsWith("dinner w/ team")) return "Dinner w/ Team";
...
export function simplifyStudentLocation(value) {
  ...
  if (lower.includes("theatre") || lower.includes("theater")) return "Campus Center Theatre";
